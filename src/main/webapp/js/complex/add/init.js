...
$("#multiplePhone").click(function(){$("#divtelephone").append("<label for='telephone'> *Tel&eacute;fono</label><div id='divtelephone'><input id='idTelephone' type='text' name='telephone' value='' ></div>")});
